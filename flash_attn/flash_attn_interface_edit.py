...
if USE_TRITON_ROCM:
    ...
    import flash_attn_2_cuda_dev as flash_attn_gpu
...
@_torch_custom_op_wrapper("flash_attn_edit::_flash_attn_forward", mutates_args=(), device_types="cuda")
...
@_torch_register_fake_wrapper("flash_attn_edit::_flash_attn_forward")
...
@_torch_custom_op_wrapper("flash_attn_edit::_flash_attn_varlen_forward", mutates_args=(), device_types="cuda")
...
@_torch_register_fake_wrapper("flash_attn_edit::_flash_attn_varlen_forward")
...
@_torch_custom_op_wrapper("flash_attn_edit::_flash_attn_backward", mutates_args=("dq", "dk", "dv"), device_types="cuda")
...
@_torch_register_fake_wrapper("flash_attn_edit::_flash_attn_backward")
...
@_torch_custom_op_wrapper("flash_attn_edit::_flash_attn_varlen_backward", mutates_args=("dq", "dk", "dv"), device_types="cuda")
...
@_torch_register_fake_wrapper("flash_attn_edit::_flash_attn_varlen_backward")
